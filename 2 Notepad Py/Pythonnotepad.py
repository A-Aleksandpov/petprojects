# simple notepad by Anton Aleksandrov for test python 3.11
...
def saving_file():
		...
		root.title(f"S PY Notepad - {file_location}")
...
def opening_file():
	...
	root.title(f"S MY Notepad - {file_location}")
		 
		 
root=tk.Tk()
root.title("S PY Notepad")
